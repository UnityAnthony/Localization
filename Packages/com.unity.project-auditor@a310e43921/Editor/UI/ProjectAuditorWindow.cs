        ...
        static void OnLoad()
        {
            ...
            ViewDescriptor.Register(new ViewDescriptor
            {
                ...
                onDrawToolbarDataOptions = (viewManager) =>
                {
                    ...
                    if (GUILayout.Button("Make SVC", EditorStyles.toolbarButton, GUILayout.ExpandWidth(true),
    GUILayout.Width(AnalysisView.toolbarButtonSize)))
                    {
                        Instance.GenerateShaderVariantCollection();
                    }
                    GUILayout.FlexibleSpace();
        ...
        public void GenerateShaderVariantCollection()
        {
            ShadersModule.GenerateShaderVariantCollection();
        }
